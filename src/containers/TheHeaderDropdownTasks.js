    ...
    >
      ...
      <CDropdownMenu placement="bottom-end" className="pt-0">
        ...
        <CDropdownItem className="d-block">
          <div className="small mb-1">Delivery of product 1  <span
            className="float-right"><strong>0%</strong></span></div>
          <CProgress size="xs" color="info" value={0} />
        </CDropdownItem>
        <CDropdownItem className="d-block">
          <div className="small mb-1">Order product 2 <span className="float-right"><strong>25%</strong></span></div>
          <CProgress size="xs" color="danger" value={25} />
        </CDropdownItem>
        <CDropdownItem className="d-block">
          <div className="small mb-1">Disposal of old products <span className="float-right"><strong>50%</strong></span></div>
          <CProgress size="xs" color="warning" value={50} />
        </CDropdownItem>
        <CDropdownItem className="d-block">
          <div className="small mb-1"> Redesign product 4 <span className="float-right"><strong>75%</strong></span></div>
